...
create table public.user_preferences (
  ...
  -- JSONB object mapping category ID → array of chosen subcategories (max 3 each)
  -- e.g. {"live-music": ["Hip-hop / Rap", "Jazz / Blues"], "sports": ["Basketball"]}
  selected_subcategories jsonb   not null default '{}',
  updated_at             timestamptz not null default now()
);
...
returns trigger as $$
begin
  -- Auto-create default "Favorites" collection
